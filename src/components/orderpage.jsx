        ...
        <div className="scroll menu_group sticky-top">
          <div className="container-fluid" id="menu_group">
            <a href="/orderpage/開胃菜">
              <button
                className="oval menu_group_list"
                onClick={this.btn_group1}
              >
                開胃菜
              </button>
            </a>

            <button className="oval menu_group_list" onClick={this.btn_group2}>
              沙拉
            </button>
            <button className="oval menu_group_list" onClick={this.btn_group3}>
              湯
            </button>
          ...
          <div id="group_1" className="d-flex flex-column">
            ...
            <div id="cate1">
              <div className="row">
                {this.state.Order.map((item, index) => (
                  <div
                    key={index}
                    className="food_list_detail food_list_border col-sm-8 col-lg-4"
                  >
                    <div>
                    ...
                    <div className="food_dollar_qty">
                      ...
                      <div className="d-flex flex-row">
                        <p>
                          <span className="dollar align-self-center">
                            {item.food_amount}
                          </span>
                          元
                        </p>
                        <input
                          type="button"
                          value="-"
                          className="btn_count count_decrease sub"
                          onclick="qty()"
                        />
            ...
            <div className="food_order_group d-flex flex-column">
              <div className="d-flex justify-content-center">
                ...
                <button
                  className="group_button oval"
                  data-toggle="modal"
                  data-target="#order_group_modal"
                >
                  揪團
                </button>
              </div>
            ...
            <div
              ...
              id="order_group_modal"
              tabindex="-1"
              role="dialog"
              aria-labelledby="order_group_modal_title"
              aria-hidden="true"
            >
              <div
              ...
              >
                <div className="modal-content">
                  <div className="modal-header">
                    <h3 className="modal-title" id="order_group_modal_title">
                      是否開啟揪團功能？
                    </h3>
                    <br />
                    <button
